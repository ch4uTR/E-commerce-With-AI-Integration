...
async function loadBestSellingProducts() {
    const response = await fetch('/api/productapi/best-selling');
        ...
        const html = `
            <div class="col-lg-3 col-md-4 col-sm-6 mix">
                <div class="featured__item">
                    <div class="featured__item__pic set-bg" data-setbg="/images/products/${p.image}">
    ...
    // set-bg iþlemini tekrar çalýþtýr
